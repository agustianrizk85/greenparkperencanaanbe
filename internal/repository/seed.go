...
// overview account, and the design authors (PIC). Change these in any real
// deployment.
//
// Defaults: ceo/ceo123, kadep/kadep123, randi/randi123, ananto/ananto123,
// agus/agus123, rio/rio123.
func seedUsers() map[string]domain.User {
	return map[string]domain.User{
		...
		"randi":  mustUser("randi", "Surandi Yanda Saputra", domain.RoleArsitek, "randi123"),
		"ananto": mustUser("ananto", "Ananto", domain.RoleArsitek, "ananto123"),
		"agus":   mustUser("agus", "Agus Priyanta", domain.RoleDrafter, "agus123"),
		"rio":    mustUser("rio", "Rio Zakaria", domain.RoleDrafter, "rio123"),
	}
}
